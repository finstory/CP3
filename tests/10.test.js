...
describe('PUT /accessories', function () {
  ...
  it('Responde con el accesorio modificado', function () {
    ...
    return supertest
      ...
      .expect(function (res) {
        expect(res.body).to.deep.eql({ id: 8, type: 'Bracelet', color: 'Gold', description: 'Golden Bracelet' })
  ...
  it('Responde con el accesorio modificado parcialmente', function () {
    ...
    return supertest
      ...
      .expect('Content-Type', /json/)
      .expect(function (res) {
        expect(res.body).to.deep.eql({ id: 8, type: 'Necklace', color: 'Red', description: 'Golden Necklace' })
        expect(controller.getAccessories()).to.have.length(1)
      })
  })
