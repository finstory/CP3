...
describe('POST /accessories', function () {
  ...
  it('Agrega un nuevo accesorio y responde con un mensaje de confirmación', function () {
    return supertest
      ...
      .expect(function (res) {
        expect(res.body).to.eql({ message: 'El accesorio Yellow Sweater fue agregado correctamente' })
  ...
  it('Si la descripción de accesorio supera los 140 caracteres, responde con un error', function () {
    return supertest
      ...
      .expect('Content-Type', /json/)
      .expect(function (res) {
        expect(res.body).to.deep.eql({ error: 'La descripción supera los 140 caracteres' })
